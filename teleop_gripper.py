#!/usr/bin/env python3
"""
hand_teleop_gripper.py — Browser-previewed hand-pinch teleop for DAS Gripper.
...
Controls:
    ...
    SPACE    -> freeze target (ignore hand tracking until pressed again)
    q / ESC  -> disable motor and quit

Usage: python teleop_gripper_test.py left
...
def main():
    global latest_jpeg
    parser = argparse.ArgumentParser(description="Webcam hand-pinch teleop")
    parser.add_argument("side", choices=["left", "right"])
    parser.add_argument("--port", type=str, default=None)
    parser.add_argument(
        "--gripper-type", type=str, default="default_gripper"
    )
